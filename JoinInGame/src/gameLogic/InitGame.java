...
import gameHandlers.LeftArmHuggingGameEventHandler;
import gameHandlers.RightArmHuggingGameEventHandler;
import gameHandlers.WiimoteAccelerationEventHandler;
import gameHandlers.WiimoteButtonsEventHandler;
import gameHandlers.WiimoteRotationEventHandler;
...
public class InitGame
{
    ...
    {
    	try{
    		Drawer d= new Drawer("img/introJoinIn.jpg");
    		Thread.sleep(2000);
    		d.loadNewImage("img/connectWiiMotes.jpg");
    		Thread.sleep(2000);
    	}catch(Exception e){
    	...
    	/*----------------------------Set wiimote 1------------------------------------*/
     	...
     	wiimoteAccelerationLauncher_1 = dm.getWiiMoteAccelerationLauncher("00191DD60E91",1);
		...
		wiimoteButtonsLauncher_1 = dm.getWiiMoteButtonsLauncher("00191DD60E91",1);
		...
		dm.getWiimoteByLabel(1).vibrateForTime(1000);
    	...
    	wiimoteAccelerationLauncher_2 = dm.getWiiMoteAccelerationLauncher("001B7AE9657D",2);
		...
		wiimoteButtonsLauncher_2 = dm.getWiiMoteButtonsLauncher("001B7AE9657D",2);
