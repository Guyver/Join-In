...
/**
 * Defines the Kinect Motor events.
...
public class KinectTotalSpaceTravelledForATimeServiceEvent  implements IEventCommModule{
	...
	/**
	 * Represents the space that the user's joint has gone over througout the given time.
	 */
	private Vector3d space;
	/**
	 * Represents The time throughout which the space was calculated.
	 */
	private long time;
