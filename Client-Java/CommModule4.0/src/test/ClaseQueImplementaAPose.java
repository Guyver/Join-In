...
public class ClaseQueImplementaAPose implements IKinectPoseService, Runnable {
	...
	public void run() {
		...
		while(true){
			...
			if(currentMovementState.compareTo(KinectUserActionEnum.BACKWARDS.name())!=0&&System.currentTimeMillis()-lastStep>1500&& lastMovementState.compareTo(KinectUserActionEnum.STAND.name())!=0){		
			 ...
			 if(System.currentTimeMillis()>lastRisedHand){
