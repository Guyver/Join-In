...
/**
 * Must be implemented which want to deal with AcceleromterEvents (from WiiMote or Nunchuks).
 * <p>
...
public interface AccelerometerListener<T> extends EventListener {
	...
	/**
	 * Must be implemented to manage the AccelerometerEvents.
	 * @param evt The new AccelerometerEvent.
	 */
