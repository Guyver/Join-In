...
Collision_Manager.prototype.testCollision = function( player_manager, scene )
{
	...
	var leftHand =  player._rig.getJoint( "handleft" ).getPosition();
	var rightHand = player._rig.getJoint( "handright" ).getPosition();
	...
	{	
		...
		{		
			...
			else if ( moveableObjects[ index ].name == "Antique" )
			{
				if( g_level == 2 )
				{
