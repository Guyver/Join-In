...
Scene_Builder.prototype.createLobbyScene = function( data, itemsCollected )
{
	this.destroyCurrentScene ();
	this.createScene( data, image_loader.getAsset( 'wallTexture.png') );
	this.createHouse( 'house', new THREE.Vector3( 8000, -100, 20000 ), new THREE.Vector3( 250,250,250 ), 6000 );
	...
	for( var i = 0; i < itemsCollected; i++ )
		this.createAntique( 'vase' , new THREE.Vector3( randomRange( 5498, 25000 ), 200, randomRange( 5498, 25000 )), new THREE.Vector3( 100, 100, 100) );	
};
