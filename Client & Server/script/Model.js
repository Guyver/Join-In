...
Model.prototype.update = function( sightNode, kinectData ){
	...
	if ( kinectData != undefined && kinectData != null )
	{
		...
		this._torso.position 		= 	this.getJointPosition( "neck" );
		this._upperArm_l.position 	= 	this.getJointPosition( "leftShoulder" );
		this._upperArm_r.position 	= 	this.getJointPosition( "rightShoulder" );
		this._forearm_l.position 	= 	this.getJointPosition( "leftElbow" );
		this._forearm_r.position 	= 	this.getJointPosition( "rightElbow" );
		this._hand_l.position 		= 	this.getJointPosition( "leftHand" );
		this._hand_r.position     	= 	this.getJointPosition( "rightHand" );
		this._upperLeg_l.position 	= 	this.getJointPosition( "leftHip" );
		this._upperLeg_r.position 	= 	this.getJointPosition( "rightHip" );
		this._lowerLeg_l.position 	= 	this.getJointPosition( "leftKnee" );
		this._lowerLeg_r.position 	= 	this.getJointPosition( "rightKnee" );
		this._foot_l.position 		= 	this.getJointPosition( "leftFoot" );
		this._foot_r .position 		= 	this.getJointPosition( "rightFoot" );	
		
		// This is so the torso points in between the hips
		var h1 = this.getJointPosition( "leftHip" );
		var h2 = this.getJointPosition( "rightHip" ); 
		...
		this._upperArm_l.lookAt( this.getJointPosition( "leftElbow") );
		this._upperArm_r.lookAt( this.getJointPosition( "rightElbow") );
		this._forearm_l.lookAt( this.getJointPosition( "leftHand") );
		this._forearm_r.lookAt( this.getJointPosition( "rightHand") );
		this._upperLeg_l.lookAt( this.getJointPosition( "leftKnee") );
		this._upperLeg_r.lookAt( this.getJointPosition( "rightKnee") );
		this._lowerLeg_l.lookAt( this.getJointPosition( "leftFoot") );
		this._lowerLeg_r.lookAt( this.getJointPosition( "rightFoot") );
