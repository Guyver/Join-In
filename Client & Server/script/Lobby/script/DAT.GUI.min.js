...
DAT.GUI = function (a) {
    ...
    var t = !1,
        ...
        x = 0,
        u = !1,
        v, y, w, z, D = function (a) {
            y = v;
            z = w;
            v = a.pageY;
            w = a.pageX;
            a = v - y;
            if (!g) if (a > 0) g = !0, l = k = 1, o.innerHTML = p || "Close Controls";
            else return;
            var b = z - w;
            if (a > 0 && l > h) {
    ...
    document.addEventListener("mouseup", function (a) {
        u && !t && j.toggle();
        if (u && t) if (x == 0 && B(), k > h) clearTimeout(r), k = n = h, s();
        else if (m.children.length >= 1) {
            var b = m.children[0].offsetHeight;
            clearTimeout(r);
            n = Math.round(l / b) * b - 1;
    ...
    if (a.domElement) a.domElement.appendChild(this.domElement);
    ...
    this.add = function () {
        ...
        e = a[c];
        if (e == void 0) DAT.GUI.error(a + " either has no property '" + c + "', or the property is inaccessible.");
        else if (a = typeof e, e = G[a], e == void 0) DAT.GUI.error("Cannot create controller for data type '" + a + "'");
        else {
    ...
    var A = function () {
            h = 0;
            for (var a in d) h += d[a].domElement.offsetHeight;
    ...
    if (DAT.GUI.guiIndex < DAT.GUI.savedAppearanceVars.length) {
        ...
        if (eval(DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][0]) == !0) {
            var l = k,
                H = DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][3];
            setTimeout(function () {
                m.scrollTop = H
            }, 0);
    ...
    }, !1), DAT.GUI.inlineCSS)) a = document.createElement("style"), a.setAttribute("type", "text/css"), a.innerHTML = DAT.GUI.inlineCSS, document.head.insertBefore(a, document.head.firstChild)
};
DAT.GUI.hidden = !1;
DAT.GUI.autoPlace = !0;
...
DAT.GUI.ControllerNumberSlider = function (a, b, d, c, i) {
    ...
    var j = function (b) {
            if (f) {
                ...
                var d = 0,
                    g = 0;
                if (c.offsetParent) {
                    do d += c.offsetLeft, g += c.offsetTop;
                    while (c = c.offsetParent);
                    c = [d, g]
                } else c = void 0;
                b = DAT.GUI.map(b.pageX, c[0], c[0] + h.domElement.offsetWidth, a.getMin(), a.getMax());
    ...
    this.__defineSetter__("value", function (b) {
        this.fg.style.width = DAT.GUI.map(b, a.getMin(), a.getMax(), 0, 100) + "%"
    });
