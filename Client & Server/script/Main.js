...
function render()
{
	...
	if( g_playersLoaded )
	{
		...
		else if( g_level == 3 )guiCtx.fillText( 'Items : '+ level_Manager._player_Manager.getPlayer()._hugCount, 10, 240 );
		...
		else if( g_level == 3 )guiCtx.fillText( 'Items : '+ level_Manager._player_Manager._otherPlayers[0]._hugCount, 275, 240 );
		...
		else if( g_level == 3 )guiCtx.fillText( 'Items : '+ level_Manager._player_Manager._otherPlayers[1]._hugCount,540, 240 );
		...
		else if( g_level == 3 )guiCtx.fillText( 'Items : '+ level_Manager._player_Manager._otherPlayers[2]._hugCount, 805, 240 );
		...
		else if( g_level == 3 )
		{
			...
			guiCtx.fillText( 'Level Goal : Please wait...', 1070, 210 );
		}
	}
};
